...
public class SimuladorBancario
{
    ...
    private double guardadorSaldoTotal;
    
    private double guardadorInteresTotal;
	...
	public SimuladorBancario( String pCedula, String pNombre )
    {
        ...
        inversion = new CDT( );
        guardadorSaldoTotal = 0;
        guardadorInteresTotal = 0;
    }
    ...
    {
    	mesActual += 1;
    	guardadorSaldoTotal = corriente.darSaldo() + ahorros.darSaldo() + darCDT().calcularValorPresente(mesActual - 1);
        ahorros.actualizarSaldoPorPasoMes( );
        guardadorInteresTotal = guardadorInteresTotal + (calcularSaldoTotal() - guardadorSaldoTotal);
    ...
    public void metodo1( int pMeses )
    {
    	...
    	guardadorSaldoTotal = corriente.darSaldo() + ahorros.darSaldo() + darCDT().calcularValorPresente(mesActual - pMeses);
    ...
    {
    	//basicamente lo que hize fue utilizar el monto total de la cuenta de ahorros, corriente y cdt sin haber sumado los intereses
    	//y lo reste al valor total con los intereses ya sumados y ahi da el valor de los intereses que se han acumulada
    	double intersaTotal = guardadorInteresTotal;
    	mesActual = 1;
    	guardadorSaldoTotal = 0;
    	guardadorInteresTotal = 0;
    	cerrarCDT();
